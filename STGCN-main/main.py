...
def get_parameters():
    ...
    parser.add_argument('--Kt', type=int, default=3) # Kt is the kernel size of 1d converlution
    ...
    parser.add_argument('--epochs', type=int, default=2, help='epochs, default as 10000')
